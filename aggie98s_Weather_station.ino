...
char ssid[] = "Connected-Crap";
char pass[] = "2109121908";
WiFiClient espClient;               //Setup WiFiClient
PubSubClient client(espClient);     //Configure MQTT

//Wunderground Updates
const char* serverName = "http://rtupdate.wunderground.com";
char ID [] = "KTXSANAN1884";          // ID of my PWS
char PASSWORD [] = "0bwqjKrP";        // Key for PWS
